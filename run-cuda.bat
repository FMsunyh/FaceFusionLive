...
python run.py --execution-provider cuda --execution-threads 60 --max-memory 60 --source "demo/images/hgf.jpg" --rtmp_input "rtmp://120.241.153.43:1935/live_input" --rtmp_output "rtmp://120.241.153.43:1935/live"
